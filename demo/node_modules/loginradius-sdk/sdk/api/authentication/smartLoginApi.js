...
module.exports = function (config) {
  ...
  */
  ...
  module.smartLoginTokenVerification = function (verificationToken, welcomeEmailTemplate) {
  ...
  */
  ...
  module.smartLoginByEmail = function (clientGuid, email,
    redirectUrl, smartLoginEmailTemplate, welcomeEmailTemplate) {
  ...
  */
  ...
  module.smartLoginByUserName = function (clientGuid, username,
    redirectUrl, smartLoginEmailTemplate, welcomeEmailTemplate) {
    if (helper.isNullOrWhiteSpace(clientGuid)) {
      return Promise.reject(helper.getValidationMessage('clientGuid'));
    }
