...
[loginradius-sdk](../README.md) / CustomObjectsApiAxiosParamCreator

# Function: CustomObjectsApiAxiosParamCreator()

> **CustomObjectsApiAxiosParamCreator**(`configuration?`): `object`
...
> **getAllCustomObjectsByQuery**: (`customobject?`, `region?`, `next?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getCustomObjectByQuery**: (`region?`, `customobject?`, `next?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **postAllCustomObjectsByQuery**: (`userProfileRequestBody`, `customobject?`, `region?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **postCustomObjectByQuery**: (`userProfileRequestBody`, `region?`, `customobject?`, `options?`) => `Promise`\<`RequestArgs`\>
