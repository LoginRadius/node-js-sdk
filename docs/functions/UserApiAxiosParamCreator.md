...
[loginradius-sdk](../README.md) / UserApiAxiosParamCreator
...
> **accountListPasskey**: (`accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **accountRemovePasskey**: (`passkeyId`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **addEmail**: (`addEmailModel`, `accessToken?`, `emailtemplate?`, `verificationurl?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **changePhoneNumber**: (`smstemplate?`, `preventWebhook?`, `xPreventWebhook?`, `accessToken?`, `isvoiceotp?`, `phoneIdModel?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **checkEmailAvailability**: (`email?`, `username?`, `preventWebhook?`, `xPreventWebhook?`, `verificationtoken?`, `otp?`, `uuid?`, `url?`, `welcomeemailtemplate?`, `gRecaptchaResponse?`, `gRecaptchaResponse2?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `hCaptchaResponse?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **deleteAccByPhoneOTP**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `gRecaptchaResponse?`, `gRecaptchaResponse2?`, `hCaptchaResponse?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `verifyDeleteAccountOtp?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **deleteAccount**: (`preventWebhook?`, `deletetoken?`, `xPreventWebhook?`, `email?`, `otp?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **deleteAccountByAccessToken**: (`emailtemplate?`, `deleteurl?`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **deleteemailbyaccesstoken**: (`deleteemailbyaccesstokenRequest`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getAccountDetails**: (`welcomeemailtemplate?`, `accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getConsentLogs**: (`accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getInvitation**: (`invitationToken`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getInvitationByInvitationId**: (`invitationid`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getPrivacyPolicyAcceptance**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getPrivacyPolicyHistory**: (`accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getVerifiedConsentWithAccessToken**: (`event`, `iscustom`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **linkSocialIdentitiesByAccessToken**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `candidateTokenModel?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **linkSocialIdentitiesByPing**: (`accessToken?`, `clientGuidBodyModel?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **removePhoneIdByToken**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **resendEmailVerification**: (`emailModel`, `verificationurl?`, `emailtemplate?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **resendPhoneOtp**: (`smstemplate?`, `accessToken?`, `isvoiceotp?`, `phoneIdModelOptional?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **sendDeleteOtp**: (`accessToken?`, `smstemplate?`, `isvoiceotp?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **sendEmailVerification**: (`emailtemplate?`, `verificationurl?`, `clientguid?`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **sendWelcomeEmail**: (`welcomeemailtemplate?`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **setorchangeusernamebyaccesstoken**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `setUserNameRequest?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **submitConsentByAccessToken**: (`consentSubmit`, `accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **submitConsentByConsentToken**: (`consenttoken`, `consentSubmit`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **unlinkSocialIdentitiesByAccessToken**: (`accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `unlinkSocialIdentityRequest?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **unlockaccountbyaccesstoken**: (`unlockaccountbyaccesstokenRequest`, `accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `gRecaptchaResponse?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `hCaptchaResponse?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **updateAccountByAccessToken**: (`updateAccountByAccessTokenRequest`, `verificationurl?`, `emailtemplate?`, `smstemplate?`, `nullsupport?`, `isvoiceotp?`, `fields?`, `gRecaptchaResponse?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `hCaptchaResponse?`, `preventWebhook?`, `xPreventWebhook?`, `accessToken?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **updateConsentByAccessToken**: (`consentUpdate`, `accessToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **updateEmail**: (`url?`, `welcomeemailtemplate?`, `preventWebhook?`, `xPreventWebhook?`, `gRecaptchaResponse?`, `gRecaptchaResponse2?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `hCaptchaResponse?`, `updateEmailRequest?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **verifyPhoneOtp**: (`verifyOtpPhoneModel`, `otp?`, `smstemplate?`, `gRecaptchaResponse?`, `gRecaptchaResponse2?`, `qqCaptchaTicket?`, `qqCaptchaRandstr?`, `hCaptchaResponse?`, `accessToken?`, `xPreventWebhook?`, `preventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
