...
[loginradius-sdk](../README.md) / RegistrationApiAxiosParamCreator

# Function: RegistrationApiAxiosParamCreator()

> **RegistrationApiAxiosParamCreator**(`configuration?`): `object`
...
> **beginPasskeyRegistration**: (`identifier`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **finishPasskeyRegistration**: (`passkeyRegisterFinish`, `verificationurl?`, `emailtemplate?`, `welcomeemailtemplate?`, `fields?`, `_options?`, `invitationToken?`, `preventWebhook?`, `xPreventWebhook?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **userRegistrationBySottEmailPhoneUserName**: (`profileRequestModel`, `emailtemplate?`, `sott?`, `welcomeemailtemplate?`, `verificationurl?`, `smstemplate?`, `preventWebhook?`, `xPreventWebhook?`, `fields?`, `xLoginRadiusSott?`, `_options?`, `invitationToken?`, `isvoiceotp?`, `options?`) => `Promise`\<`RequestArgs`\>
