...
[loginradius-sdk](../README.md) / MultipurposeTokensApiFp

# Function: MultipurposeTokensApiFp()

> **MultipurposeTokensApiFp**(`configuration?`): `object`
...
> **forgotPasswordTokenAndEmail**(`forgotPasswordTokenAndEmailRequest`, `sendemail?`, `resetpasswordurl?`, `emailtemplate?`, `xPreventWebhook?`, `preventWebhook?`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`ForgotPasswordTokenModel`](../loginradius-sdk/namespaces/Models/interfaces/ForgotPasswordTokenModel.md)\>\>
...
`Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`ForgotPasswordTokenModel`](../loginradius-sdk/namespaces/Models/interfaces/ForgotPasswordTokenModel.md)\>\>

#### Throws

### getVerificationToken()

> **getVerificationToken**(`vtype`, `email?`, `expiresIn?`, `sendemail?`, `verificationurl?`, `emailtemplate?`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`VerificationLinkResponse`](../loginradius-sdk/namespaces/Models/interfaces/VerificationLinkResponse.md)\>\>
...
`Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`VerificationLinkResponse`](../loginradius-sdk/namespaces/Models/interfaces/VerificationLinkResponse.md)\>\>

#### Throws

### multipurposeEmailTokenAPI()

> **multipurposeEmailTokenAPI**(`tokentype`, `multipurposeEmailTokenAPIRequest`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`GenerateTokenResponse`](../loginradius-sdk/namespaces/Models/interfaces/GenerateTokenResponse.md)\>\>
...
`Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`GenerateTokenResponse`](../loginradius-sdk/namespaces/Models/interfaces/GenerateTokenResponse.md)\>\>

#### Throws

### multipurposeSmsOtpAPI()

> **multipurposeSmsOtpAPI**(`smsotptype`, `multipurposeSmsOtpAPIRequest`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`GenerateTokenResponse`](../loginradius-sdk/namespaces/Models/interfaces/GenerateTokenResponse.md)\>\>
