...
module.exports = function (config) {
  ...
  */
  ...
  module.authGetRegistrationData = function (type, limit,
    parentId, skip) {
  ...
  */
  ...
  module.getRegistrationData = function (type, limit,
    parentId, skip) {
    if (helper.isNullOrWhiteSpace(type)) {
      return Promise.reject(helper.getValidationMessage('type'));
    }
  ...
  */
  ...
  module.addRegistrationData = function (registrationDataCreateModelList) {
    if (helper.checkJson(registrationDataCreateModelList)) {
      return Promise.reject(helper.getValidationMessage('registrationDataCreateModelList'));
    }
    var queryParameters = {};
    ...
    return config.request('POST', resourcePath, queryParameters, registrationDataCreateModelList);
  };
  ...
  */
  ...
  module.updateRegistrationData = function (registrationDataUpdateModel, recordId) {
    if (helper.checkJson(registrationDataUpdateModel)) {
      return Promise.reject(helper.getValidationMessage('registrationDataUpdateModel'));
    }
    if (helper.isNullOrWhiteSpace(recordId)) {
      return Promise.reject(helper.getValidationMessage('recordId'));
    }
