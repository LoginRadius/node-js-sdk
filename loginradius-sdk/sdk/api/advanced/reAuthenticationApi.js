...
module.exports = function (config) {
  ...
  */
  ...
  module.mfaReAuthenticateByOTP = function (accessToken, reauthByOtpModel) {
    ...
    return config.request('PUT', resourcePath, queryParameters, reauthByOtpModel);
  };
  ...
  */
  ...
  module.mfaReAuthenticateByBackupCode = function (accessToken, reauthByBackupCodeModel) {
    if (helper.isNullOrWhiteSpace(accessToken)) {
      return Promise.reject(helper.getValidationMessage('accessToken'));
    }
    ...
    return config.request('PUT', resourcePath, queryParameters, reauthByBackupCodeModel);
  };
  ...
  */
  ...
  module.mfaReAuthenticateByGoogleAuth = function (accessToken, reauthByGoogleAuthenticatorCodeModel) {
    if (helper.isNullOrWhiteSpace(accessToken)) {
      return Promise.reject(helper.getValidationMessage('accessToken'));
    }
    if (helper.checkJson(reauthByGoogleAuthenticatorCodeModel)) {
      return Promise.reject(helper.getValidationMessage('reauthByGoogleAuthenticatorCodeModel'));
    }
    var queryParameters = {};
    ...
    return config.request('PUT', resourcePath, queryParameters, reauthByGoogleAuthenticatorCodeModel);
  };
  ...
  */
  ...
  module.mfaReAuthenticateByPassword = function (accessToken, passwordEventBasedAuthModelWithLockout,
    smsTemplate2FA) {
    if (helper.isNullOrWhiteSpace(accessToken)) {
      return Promise.reject(helper.getValidationMessage('accessToken'));
    }
    if (helper.checkJson(passwordEventBasedAuthModelWithLockout)) {
      return Promise.reject(helper.getValidationMessage('passwordEventBasedAuthModelWithLockout'));
    }
    var queryParameters = {};
    ...
    return config.request('PUT', resourcePath, queryParameters, passwordEventBasedAuthModelWithLockout);
  };
  ...
  */
  ...
  module.verifyMultiFactorOtpReauthentication = function (eventBasedMultiFactorToken, uid) {
    if (helper.checkJson(eventBasedMultiFactorToken)) {
      return Promise.reject(helper.getValidationMessage('eventBasedMultiFactorToken'));
    }
  ...
  */
  ...
  module.verifyMultiFactorPasswordReauthentication = function (eventBasedMultiFactorToken, uid) {
    if (helper.checkJson(eventBasedMultiFactorToken)) {
      return Promise.reject(helper.getValidationMessage('eventBasedMultiFactorToken'));
    }
    if (helper.isNullOrWhiteSpace(uid)) {
  ...
  */
  ...
  module.verifyMultiFactorPINReauthentication = function (eventBasedMultiFactorToken, uid) {
    if (helper.checkJson(eventBasedMultiFactorToken)) {
      return Promise.reject(helper.getValidationMessage('eventBasedMultiFactorToken'));
    }
    if (helper.isNullOrWhiteSpace(uid)) {
  ...
  */
  ...
  module.verifyPINAuthentication = function (accessToken, pINAuthEventBasedAuthModelWithLockout,
    smsTemplate2FA) {
    if (helper.isNullOrWhiteSpace(accessToken)) {
      return Promise.reject(helper.getValidationMessage('accessToken'));
    }
    if (helper.checkJson(pINAuthEventBasedAuthModelWithLockout)) {
      return Promise.reject(helper.getValidationMessage('pINAuthEventBasedAuthModelWithLockout'));
    }
    var queryParameters = {};
