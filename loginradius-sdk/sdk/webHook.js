module.exports = function (config) {
    ...
    module.test = function (fields) {
        ...
        return new Promise(function (resolve, reject) {
            config.request({uri: config.apidomain + webHookEndpoint +"/test?apikey=" + config.apikey + "&apisecret=" + config.apisecret+config.serverRegion}, function (data, status) {
    ...
    module.subscribe = function (target_url, event, fields) {
        ...
        return new Promise(function (resolve, reject) {
            config.request({
                method: 'POST',
                uri: config.apidomain + webHookEndpoint +"/?apikey=" + config.apikey + "&apisecret=" + config.apisecret+config.serverRegion,
