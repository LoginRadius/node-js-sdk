module.exports = function ( config ) {
	...
	module.postObjectCreateUpdate = function( objectid, uid, custom ) {

		// Additional Custom json object
		config.request( { method: 'POST', uri: apiDomain + "/raas/v1/user/customObject/upsert?appkey=" + apiKey + "&appsecret=" + apiSecret + "&objectid=" + objectid + "&accountid=" + uid, form: custom, headers: { 'content-type': 'application/x-www-form-urlencoded' } }, function ( data ) {
